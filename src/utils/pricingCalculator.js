...
export const calculatePricing = (pricingData) => {
  const pricing = {
    velo: getPriceByCategory(pricingData, 'VCH-5000-D1N'),
    vpod: getPriceByCategory(pricingData, 'VCH-5000-S1N'),
    jbod78_16: getPriceByCategory(pricingData, 'VCH-5000-J78-1248'),
    jbod78_24: getPriceByCategory(pricingData, 'VCH-5000-J78-1842s'),
    jbod78_30: getPriceByCategory(pricingData, 'VCH-5000-J78-2340'),
    jbod78_32: getPriceByCategory(pricingData, 'VCH-5000-J78-2496'),
    jbod78_18: getPriceByCategory(pricingData, 'VCH-5000-J78-1404s'),
    jbod108_16: getPriceByCategory(pricingData, 'VCH-5000-J108-1728'),
    jbod108_24: getPriceByCategory(pricingData, 'VCH-5000-J108-2592s'),
    jbod108_30: getPriceByCategory(pricingData, 'VCH-5000-J108-3240'),
    jbod108_32: getPriceByCategory(pricingData, 'VCH-5000-J108-3456'),
